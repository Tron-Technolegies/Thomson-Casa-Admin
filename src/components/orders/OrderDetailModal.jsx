          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-6">
            ...
            <div className="md:col-span-2">
              ...
              <div className="relative">
                <select defaultValue={order.customer} className="h-13 w-full appearance-none rounded-2xl border border-gray-300 px-5 outline-none focus:border-[#4B5EAA] bg-white">
                  <option>Raj Foods Pvt Ltd</option>
            ...
            <div>
              ...
              <div className="relative">
                <select defaultValue={order.type} className="h-13 w-full appearance-none rounded-2xl border border-gray-300 pl-10 pr-5 outline-none focus:border-[#4B5EAA] bg-white">
